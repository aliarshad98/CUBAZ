<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Search.aspx.cs" Inherits="CUBAZ.Search" %>
...
<body>
  ...
  <header>
	 ...
	 <h2>Search for an Item Here</h2>
	<form id="form1" runat="server">
		<div>
		   
			<asp:TextBox ID="inputItem" runat="server" />
			<asp:Button Text="Search" ID="inp" OnClick="Search_Click" runat="server" />
			
			<asp:GridView  ID="SearchId" runat="server">
