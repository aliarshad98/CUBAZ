<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Admin.aspx.cs" Inherits="CUBAZ.Admin" %>
  ...
  <header>
    ...
    <form action="/" method="post" id="form1" runat="server">
        ...
        <div >
            <h1>Admin View</h1>
        <br /><br />
        <asp:GridView ID="AdminViewSearch" runat="server"></asp:GridView>
        </div>
        
     <div class="base">
            <br /><br />
            <asp:TextBox runat="server" id="DelCustomer" PlaceHolder="Input the Id of the Customer whom you want to delete" ></asp:TextBox>
            
            <asp:Button ID="DeleteCustomerButton" OnClick="DeleteCustomer_Click" runat="server"  Text="Delete" />
            <br />
